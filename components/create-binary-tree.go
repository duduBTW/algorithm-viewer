...
var nodes = []int{}
var clearButton js.Value
var form js.Value

var CreateBinaryTreeComponent = BaseComponent{
	Target:    CreateBinaryTreeIds.TreeContainer,
	Component: BinaryTree(algorithms.CreateBinaryTree(nodes)),
	SetupFn: func(reRender func()) func() {
		...
		return func() {
			clearButton.Call("removeEventListener", "click", clearClickHandler)
			form.Call("removeEventListener", "submit", addNodeFormSubmitHandler)
		}
	},
}
